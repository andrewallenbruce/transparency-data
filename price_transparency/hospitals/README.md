...
| **machine_readable_url_status** | Machine Readable URL Status | Enum("up", "down", "corrupt") | A status code for the purported url for the machine readable file resource. | No | up| 
...
| **file_format** | File Format | Enum("csv", "json", "xml", "xlsx", "zip/csv", "zip/json", "zip/xml", "zip/xlsx", "other") | Format of the file. | No | csv |
| **file_size** | File Size | Int | Size of the referenced MRF, in bytes. | No | 1024 |
